var BasicGame = {
    ...
    MAX_WATCHER_COUNT: 50,
    WATCHER_VISION_DEGREE: 45,
    WATCHER_TURN_RATE: 1,
    WATCHER_MOVE_DELAY_MIN: Phaser.Timer.SECOND * 2,
    WATCHER_MOVE_DELAY_MAX: Phaser.Timer.SECOND * 5,
    WATCHER_MOVE_SPEED: 150,

    SEA_SCROLL_SPEED: 12,
    PLAYER_SPEED: 200,
    ENEMY_MIN_Y_VELOCITY: 60,
    ENEMY_MAX_Y_VELOCITY: 90,
    ...
    INSTRUCTION_EXPIRE: Phaser.Timer.SECOND * 7,
